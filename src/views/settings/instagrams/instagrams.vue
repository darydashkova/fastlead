                ...
                <div class="settings-instagrams__element" v-for="instagram in instagrams"
                    ...
                    <div class="settings-instagrams__name">
                        ...
                        <div class="settings-instagrams__action-container">
                            ...
                            <div class="settings-instagrams__action settings-instagrams__action_del pointer"
                                 @click="del(instagram)"
                            >
                    ...
                    <div class="settings-instagrams__phone"
                        :class="{
                            ...
                            'settings-instagrams__phone_error': instagram.status_id === 2 && instagram.status_id === 3,
                        }"
                    >
                        {{instagram.status}}
                    </div>
