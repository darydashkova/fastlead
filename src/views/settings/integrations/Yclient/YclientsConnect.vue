           ...
           <div class="settings-integrations-yclient__pattern-tasks">
               <div class="settings-integrations-form__field">
                ...
                <template v-if="cooseDate.type">
                    <button class="settings-integrations-form__input settings-integrations-form__select" :class="{'settings-integrations-form__select_active': statusSelect }"> 
...
<script>
    ...
    export default {
        components: {integrationHeaderCommon, BirthdayPattern},
        setup() {
...
watch(()=>{
    if(checkEdit.value&&data.value.yclients_task){  
        textOption.value='Поздравление с днём рождения' 
