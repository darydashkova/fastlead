<template>
    <div class="settings-templates-messages">
        <div class="settings-templates-messages__header">
            <div>
                Шаблоны сообщений
            </div>
            <BaseButton v-if="false" class="base-button_cancel base-button_p5-15">Отмена</BaseButton>
            <BaseButton v-else class="base-button_enter base-button_p5-15">Создать новый</BaseButton>
        </div>
        <div class="settings-templates-messages__scroll-container">
            <div class="scroll" ref="container" @click.self="scrollTo">
                <div class="scroll__bar" ref="scrollbar"></div>
            </div>
            <div class="settings-templates-messages__content" ref="content">
                <div class="settings-templates-messages__element" v-for="i in 4">
                    <div class="settings-templates-messages__message">
                        <div class="settings-templates-messages__message-scroll">
                    ...
                    <div class="settings-templates-messages__name">
                        <span>
                            Довольно крупное название смс
                        </span>
                        <div class="settings-templates-messages__action-container">
                            <div class="settings-templates-messages__action settings-templates-messages__action_default pointer"
                            >
                            ...
                            <div class="settings-templates-messages__action settings-templates-messages__action_del pointer"
                            >
...
<style lang="scss" src="./templates-messages.scss"></style>