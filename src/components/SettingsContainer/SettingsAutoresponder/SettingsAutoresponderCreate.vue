        ...
        <template v-if="!isSecondStep">
            ...
            <div class="settings-autoresponder-create__input-group settings-autoresponder-create__input-group_m-48">
                ...
                <div class="settings-autoresponder-create__row settings-autoresponder-create__row_m-0">
                    <div class="settings-autoresponder-create__iconed-input settings-autoresponder-create__iconed-input_w-45">
                        <button class="settings-autoresponder-create__input settings-autoresponder-create__input_selector pointer"
                    ...
                    <div class="settings-autoresponder-create__button-container">
                        <div class="settings-autoresponder-create__button-add-new"
...
<style lang="scss">
    ...
    .settings-autoresponder-create__iconed-input {
        ...
        &.settings-autoresponder-create__iconed-input_w-45 {
            width: 45%;
        }
    }
    ...
    .settings-autoresponder-create__button-container {
        width: 45%;
    }
    .settings-autoresponder-create__button-add-new {
        position: relative;
        font-style: normal;
        font-weight: normal;
        font-size: 18px;
