    ...
    <div class="settings-autoresponder-card">
        <div class="settings-autoresponder-card__container">
            ...
            <div class="settings-autoresponder-card__actions-container">
                <svg @click="del" class="pointer" style="margin-right: 18px" width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg class="pointer" width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div @click="open" class="settings-autoresponder-card__container">
            <textarea class="settings-autoresponder-card__message"></textarea>
            <div class="settings-autoresponder-card__links-container">
                <div class="settings-autoresponder-card__link-name">Ответили</div>
                <div class="settings-autoresponder-card__link-name">Всегда</div>
                <div class="settings-autoresponder-card__link-name">Не ответили</div>
            </div>
        </div>
        <div class="settings-autoresponder-card__link"
             :style="{
                'left': i < 3 && '-5.5px',
                'right': i > 2 && '-5.5px',
                'bottom': i * 25 + 'px',
...
<style lang="scss">
    .settings-autoresponder-card {
        background: var(--hover-folder-bg);
        border: 1px solid var(--search-input-placeholder-color);
    ...
    .settings-autoresponder-card__container {
        margin-bottom: 11px;
        display: flex;
        align-items: center;
    ...
    .settings-autoresponder-card__header {
        font-style: normal;
        font-weight: normal;
        font-size: 16px;
        line-height: 21px;
    ...
    .settings-autoresponder-card__message {
        border-radius: 7px;
    ...
    .settings-autoresponder-card__actions-container {
        display: flex;
        align-items: center;
    }
    .settings-autoresponder-card__links-container {
        display: flex;
        height: 100%;
        flex-direction: column;
        justify-content: space-around;
    }
    .settings-autoresponder-card__link-name {
        font-style: normal;
        font-weight: normal;
        font-size: 14px;
        line-height: 19px;
        ...
        &.settings-autoresponder-card__link-name_active {
            background: var(--green-color);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
        }
    }
    .settings-autoresponder-card__link {
        border-radius: 50%;
        width: 11px;
        height: 11px;
        position: absolute;
