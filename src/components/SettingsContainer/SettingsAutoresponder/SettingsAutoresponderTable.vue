        ...
        >
            ...
            <td>
                <div class="settings-autoresponder-table__actions-container">
                    ...
                    <div class="settings-autoresponder-table__action settings-autoresponder-table__action_red pointer"
                        @click="del(autoresponder.autoresponder_id)"
                    >
...
<style lang="scss">
    ...
    .settings-autoresponder-table__actions-container {
        ...
        .settings-autoresponder-table__action {
            ...
            &.settings-autoresponder-table__action_red {
