    ...
    <div class="settings-integration-variables">
        ...
        <div v-for="(variable, index) in variables" :key="index" class="settings-integration-variables__copy" >
            <div class="settings-integration-variables__copy-title">
                <div class="settings-integration-variables__copy-title-name"> {{ variable[0] }}</div>&nbsp - &nbsp
                <div  class="settings-integration-variables__copy-title-description"> {{ variable[1] }}</div> 
            </div>

            <svg @click="pasteText( variable[0])" class="pointer" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
         ...
         <div class="settings-integration-variables__copy settings-integration-variables__show" >
           ...
           <svg   @mouseover="openModal = true" @mouseleave="openModal = false" @click="copySample"  width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" class="pointer">
            ...
            <SettingsIntegrationModalSample v-show="openModal" :copyText="copyText" @copiedText ="getText"></SettingsIntegrationModalSample>
        </div> 
        </div>
    </div>
    </div>
