<template>
     <div class="settings-integrations-tasks">
                    <input class="settings-integrations-tasks__input" disabled :value="getFullTaskName(data.id)">
                    <!-- :value="name + ' / ' + phone +' / '+ (active?'активен':'неактивен')" -->
                    <div @click="clickAmoSettings()">
...
export default {
    ...
    const fullName = ref('');
        const clickAmoSettings = () => {
            emit("clickAmoSettings",   task.value?.whatsapp_id)
        }
        const getFullTaskName = (id) => {
