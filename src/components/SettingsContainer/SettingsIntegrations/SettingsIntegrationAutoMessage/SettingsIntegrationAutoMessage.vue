        ...
        <div type="text" class="settings-integrations-form__input settings-integrations-form__popup" @click="showPopup(indexItem), showText(indexItem)" @close="close"> 
            <!-- <template v-if="automessageArray[indexItem]">
                <template v-if="automessageArray[indexItem][0]!=null"> 
                   ...
                   <template v-if="updateMessage&&(updateMessage.hasOwnProperty('type'))">
            ...
            <svg :class ="{'settings-integrations-form__dropdown-inner-svg_green': (isPopup&&(indexPopup==indexItem)) }" class='settings-integrations-form__input-edit' width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg" >
