                    ...
                    >
                        ...
                        <td>
                            <div class="settings-mailings-table__actions-container">
                                ...
                                >
                                    <svg width="14" class="settings-mailings-table__action_width" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<script>
    ...
    export default {
        setup(props, {emit}) {
            ...
            const del = (mailing) => {
                let callback = () => deleteMailing([mailing.mass_sending_id])
                    .then(() => {
                        getMailings();
                    })
                setTextModalConfirmDelete(`Вы точно хотите удалить пользовательскую рассылку "${mailing.name}"?`)
