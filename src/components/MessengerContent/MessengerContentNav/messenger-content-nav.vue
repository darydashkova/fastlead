    ...
    <div class="messenger-content-nav">
        <div class="messenger-content-nav__ava-container">
            ...
            <svg
                ...
                <circle cx="22" cy="22" r="22" fill="#404054"/>
                <path d="M12 15H32" stroke="white" stroke-width="2" stroke-linecap="round"/>
                <path d="M12 22H32" stroke="white" stroke-width="2" stroke-linecap="round"/>
                <path d="M12 29H32" stroke="white" stroke-width="2" stroke-linecap="round"/>
            </svg>
