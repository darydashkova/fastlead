    ...
    <div class="modal-move-chat" @mousedown.self="toggleModalMoveChat(false)">
        <div class="modal-move-chat__body">
            ...
            <div class="modal-move-chat__folders-list">
                <div class="modal-move-chat__folder" v-for="folder in folders">
                    ...
                    <svg class="modal-move-chat__folder-icon" width="33" height="35" viewBox="0 0 33 35" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            const { toggleModalMoveChat } = useModals();
