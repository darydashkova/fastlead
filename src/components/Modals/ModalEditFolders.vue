    ...
    <div class="modal-edit-folders" @mousedown.self="closeModal">
        <div class="modal-edit-folders__body">
            ...
            <div class="modal-edit-folders__folders-list">
                <div class="modal-edit-folders__folder" v-for="folder in folders">
                    ...
                    <template v-if="!folder.is_default">
                        <button v-if="deletingIds.find(i => i === folder.folder_id)" @click="removeFromDel(folder.folder_id)" class="modal-edit_folders__cancel-delete pointer">
                        <span class="modal-edit_folders__btn-text">
                            Отмена
                        </span>
                        </button>
                        <svg v-else @click="addToDel(folder.folder_id)" class="modal-edit-folders__delete pointer" width="17" height="22" viewBox="0 0 17 22" fill="none" xmlns="http://www.w3.org/2000/svg">
