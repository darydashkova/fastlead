<template>
    ...
    >
        <div class="base-message__container"
             :class="{'base-message__container_full': message.type === 'img'}"
        >
            <div class="base-message__message"
                :class="{'base-message__message_full': message.type === 'img'}"
            >
                ...
                <div v-if="message.type === 'img'" class="base-message__image"
