<template>
    <div class="base-message-input">
        ...
        <svg class="base-message-input__icon base-message-input__icon_smile" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg class="base-message-input__icon base-message-input__icon_include" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg v-if="value"
             @click="send"
             class="base-message-input__icon base-message-input__icon_airplane" width="23" height="22" viewBox="0 0 23 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg v-else class="base-message-input__icon base-message-input__icon_micro" width="15" height="22" viewBox="0 0 15 22" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<style lang="scss">
    ...
    .base-message-input__icon_include {
        position: absolute;
        left: 17px;
        bottom: 14px;
    }

    .base-message-input__icon_smile {
        position: relative;
        bottom: 14px;
        margin-left: 21px;
        min-width: 22px;
    ...
    .base-message-input__icon_micro {
        position: relative;
        bottom: 14px;
        margin-left: 20px;
        margin-right: 4px;
    ...
    .base-message-input__icon_airplane {
        position: relative;
        bottom: 14px;
        margin-left: 16px;
        min-width: 23px;
