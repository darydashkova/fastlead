...
```js
import data from 'emoji-component/data/all.json'
import { Picker, EmojiIndex } from 'emoji-component'
let emojiIndex = new EmojiIndex(data)
```
...
```js
import data from 'emoji-component/data/facebook.json'
import { Picker, EmojiIndex } from 'emoji-component'
...
```js
import data from 'emoji-component/data/all.json'
import { Emoji, EmojiIndex } from 'emoji-component'
```
...
```js
import { EmojiIndex } from 'emoji-component'
import data from 'emoji-component/data/all.json'
...
```js
import data from 'emoji-component/data/facebook'
import { EmojiIndex } from 'emoji-component'
...
```js
import { store } from 'emoji-component'
...
<script>
import data from 'emoji-component/data/all.json'
import { EmojiIndex } from 'emoji-component/src/utils/emoji-data'
import EmojiMartPicker from 'emoji-component/src/components/Picker'

import { PickerProps } from 'emoji-component/src/utils/shared-props'
...
import data from 'emoji-component/data/all.json'
import { EmojiIndex } from 'emoji-component/src/utils/emoji-data'
import EmojiMartEmoji from 'emoji-component/src/components/Emoji'

import { EmojiProps } from 'emoji-component/src/utils/shared-props'
