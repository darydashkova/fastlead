<template>
    <div class="messages-container-input">
        <textarea class="messages-container-input__input"
                  ...
                  @keypress="isEnter"
        ></textarea>
        <div class="messages-container-input__input messages-container-input__input_hidden-div" tabindex="-1"></div>

        <svg class="messages-container-input__icon messages-container-input__icon_smile" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg class="messages-container-input__icon messages-container-input__icon_include" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<script>
    ...
    export default {
        setup() {
            ...
            const resize = () => {
                let hiddenDiv = document.querySelector('.messages-container-input__input_hidden-div');
...
<style lang="scss">
    ...
    .messages-container-input__input_hidden-div {
        position: absolute;
        display: none;
        visibility: hidden;
